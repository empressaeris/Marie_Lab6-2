...
Level.prototype.obstacleAt = function (pos, size) {
  ...
  // Consider the sides and top and bottom of the level as wells.
  if (xStart < 0 || xEnd > this.width || yStart < 0 || yEnd > this.height)
  return "wall";

  // Check each grid position starting at yStart and xStart.
  // While also checking for possible obstacles. (Not null value.)
...
Player.prototype.moveY = function(step, level, keys) {
  // Accelerate player downplay always.
  ...
  // the floor is also an obstacle -- only allows the players to jump.
  // if they are touching the obstacle.
  if (obstacle) {
